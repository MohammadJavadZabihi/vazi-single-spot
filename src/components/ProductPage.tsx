...
const sampleProduct: Product = {
  id: "1",
  name: "Ultra Clean All-Purpose Disinfectant Spray",
  price: 12.99,
  originalPrice: 16.99,
  rating: 4.8,
  reviewCount: 247,
  description: "Professional-grade disinfectant spray that kills 99.9% of germs and bacteria. Perfect for kitchens, bathrooms, and all surfaces. Fresh mint scent leaves your home smelling clean and fresh.",
  images: [
    disinfectantMain,
    disinfectantSide,
    disinfectantBack
